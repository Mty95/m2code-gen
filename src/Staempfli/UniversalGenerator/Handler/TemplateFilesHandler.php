...
class TemplateFilesHandler
{
    ...
    public function clearTemplateAndDependecyFiles()
    {
        $this->files = [];
    }
    ...
    protected function setFile(\SplFileInfo $file)
    {
        ...
        if ($pathKey !== false) {
            ...
            $this->files[] = [
                'path' => $filePath,
                'content' => $fileContent,
                'template_path' => $file->getPathname(),
            ];
        }
    }
    ...
    /**
     * @return TemplateFilesHelper
     */
    public function getTemplateFilesHelper(): TemplateFilesHelper
    {
        return $this->templateFilesHelper;
    }
